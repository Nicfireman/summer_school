...
if all_money > 0:
    if key == "400":
        print("К получению {0:9.2f} EUR".format(all_money/EURO))
    elif key == "401":
        print("К получению {0:9.2f} USD".format(all_money/Dollar))
    elif key == "402":
        print("К получению {0:9.2f} GRIV".format(all_money/grivna))
    else:
